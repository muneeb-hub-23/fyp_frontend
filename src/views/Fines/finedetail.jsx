...
const ApiCaller = async ()=>{
    try {
        const response1 = await axios.post(apiaddress+'/get-student-info',{value:{admission_number:adn}});
        setStudent(response1.data)

        const response2 = await axios.post(apiaddress+'/detailedfines',{admission_number:adn,sdate,ldate});
        await setFine(response2.data);
